...
<head>
<meta charset="utf-8">
<title>Restoran -Restaurant</title>
		...
		<div class="container-xxl py-5">
			<div class="container">
				<div class="row g-4">
					...
					<form id="myForm" action="ReadFourServiceModule" method="post">
					...
					if (message == null) {
						...
						for (ServiceModulePojo pojo : arrayList) {
					%>
					...
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="service-item rounded pt-3">
							<div class="p-4">
								<i class="fa fa-3x <%=pojo.getIconname() %> text-primary mb-4"></i>
                                <h5><%=pojo.getTitle() %></h5>
                                <p><%=pojo.getDescription() %></p>
							</div>
						</div>
					</div>
					<%
				...
				<div class="row g-5 align-items-center">
					<div class="col-lg-6">
						<div class="row g-3">
							...
							<div class="col-6 text-end">
								<img class="img-fluid rounded w-75 wow zoomIn"
									data-wow-delay="0.5s" src="img/about-2.jpg">
							</div>
							<div class="col-6 text-end">
								<img class="img-fluid rounded w-100 wow zoomIn"
					...
					<div class="col-lg-6">
						...
						<p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor
							diam ipsum sit. Aliqu diam amet diam et eos erat ipsum et lorem
							et sit, sed stet lorem sit.</p>
						<p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor
								...
								<div class="col-lg-6">
									<div class="d-flex align-items-center">
										...
										<div class="w-100 d-flex flex-column text-start ps-4">
											...
											<small class="fst-italic">Ipsum ipsum clita erat amet
												dolor justo diam</small>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
